...
- Rig side panel with persisted settings (tight, volume, mute grip, picking, double tracking, engine, cab, palm-mute bank, note bank, player rules, legato landings, ring time, feedback, NAM input, room, bass rig, loop).
