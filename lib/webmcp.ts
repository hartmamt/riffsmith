  ...
  return [
    ...
    },
    {
      ...
      execute: async (args) => {
        ...
        for (const k of ["tight", "volume", "mute_grip"] as const) {
          if (args[k] !== undefined) {
